    ...
    document.querySelectorAll('.P_download-btn').forEach(button => {
        button.addEventListener('click', (event) => {
            ...
            <div class="payment-slip" id="payment-slip">
                ...
                <p>
                    For any queries related to this payment, please contact us at: <a href="mailto:goracings@swyomsoft.com">goracings@swyomsoft.com</a>/<a href="tel:+912040008444">020-40008444</a>
                </p>
            </div>
            `;
