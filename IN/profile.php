...
<div class="sub-header-2">
  ...
  <div class="columns">
    ...
    <div class="header-column-4">
      <h6><a href="profile.php" class="sub-header-2active">उपयोगकर्ता प्रोफ़ाइल</a></h6>
    </div>
  </div>
...
<!-- ***** दूसरा सब हेडर एरिया समाप्त ***** -->
  ...
  <div class="profile-area">
    ...
    <ul>
      ...
      <li><a href="#profile-info" class="tab-link">प्रोफ़ाइल</a></li>
      <li><a href="#organizer-info" class="tab-link">आयोजक प्रबंधन</a></li>
      <li><a href="#participants-info" class="tab-link">प्रतिभागी प्रबंधन</a></li>
      <li><a href="#audience-info" class="tab-link">दर्शक प्रबंधन</a></li>
    </ul>
    </div>
    ...
    <div class="profile-area-details">
      <div class="O-Prize-content">
        <div id="Organizer-Prize" class="tab-content">
          <h5>आयोजक पुरस्कार जानकारी:</h5><br>
          <?php
          include 'gRconn.php';
      ...
      <div class="P-Prize-content">
        <div id="Participant-Prize" class="tab-content">
          <h5>प्रतिभागी पुरस्कार जानकारी:</h5><br>
          <?php
          include 'gRconn.php';
          ...
          if ($conn) {
            ...
            if ($stmt) {
              ...
              while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                  echo "<tr>";
                  echo "<td class=\"table-head\">नाम:</td><td>" . $row['UserName'] . "</td>";
                  echo "</tr>";
                  echo "<tr>";
                  echo "<td class=\"table-head\">मोबाइल नंबर:</td><td>" . $row['UserMobileNumber'] . "</td>";
                  echo "</tr>";
                  echo "<tr>";
                  echo "<td class=\"table-head\">ईमेल:</td><td>" . $row['UserEmailID'] . "</td>";
                  echo "</tr>";
                  echo "<tr>";
                  echo "<td class=\"table-head\">पता:</td><td>" . $row['UserAddress'] . "</td>";
                  echo "</tr>";
                  echo "<tr>";
                  echo "<td class=\"table-head\">यूनिक कोड:</td><td>" . $row['UserAllotedTokenNumber'] . "</td>";
                  echo "</tr>";
              }
    ...
    $paymentId = isset($paymentDetails[$tokenNumber]) ? $paymentDetails[$tokenNumber] : 'N/A';
      ...
      <div class="participant-content">
        <div id="participants-info" class="tab-content">
          <h5>प्रतिभागियों की दौड़ संबंधी जानकारी:</h5><br>
...
//////////////////
      ...
      <div class="audience-content">
        <div id="audience-info" class="tab-content">
          <h5>दर्शकों की बुकिंग संबंधी जानकारी:</h5><br>
