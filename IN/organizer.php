...
<div class="sub-header-2">
  ...
  <div class="columns">
    <div class="header-column-1">
      <h6><a href="audience.php">दर्शक</a></h6>
    </div>
...
<!-- ***** दूसरा सब हेडर एरिया समाप्त ***** -->
    ...
    <div class="organizer-container">
        ...
        <label for="race_name" id="race_name">रेस नाम:</label>
            <select id="race_name" onchange="showOtherRaceInput(this)" name="race_name" >
                <option value="">रेस नाम चुनें</option>
                ...
                <option value="newone" style="font-weight:bold;">अन्य</option>
            </select>
            <input type="text" id="other_race" name="other_race" placeholder="अन्य रेस का नाम दर्ज करें" style="display:none">
            ...
            <label for="UserDistirct">ज़िला:</label>
            ...
            <label for='Longitude'>देशांतर:</label>
            <input type='text' name='longitude' id='longitude' >
            
            <div id="map"></div>

            <label for="race_dt_time">रेस तिथि और समय:</label>
            ...
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('o_photo_id')">
            ...
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('gram_panchayat_agreement')">
            <span id="gram_panchayat_agreement_path"></span>
            <input type="file" class="fileInput" style="display: none;" id="gram_panchayat_agreement" name="gram_panchayat_agreement">

            <label for="race_permission_letter">3. Race Permission Letter</label>
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('race_permission_letter')">
            <span id="race_permission_letter_path"></span>
            <input type="file" class="fileInput" style="display: none;" id="race_permission_letter" name="race_permission_letter">

            <label for="race_permit_application">4. Race Permit Application</label>
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('race_permit_application')">
            <span id="race_permit_application_path"></span>
            <input type="file" class="fileInput" style="display: none;" id="race_permit_application" name="race_permit_application">

            <label for="route_map_course_certification">5. Route Map and Course Certification</label>
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('route_map_course_certification')">
            <span id="route_map_course_certification_path"></span>
            <input type="file" class="fileInput" style="display: none;" id="route_map_course_certification" name="route_map_course_certification">

            <label for="safety_emergency_plan">6. Safety and Emergency Plan</label>
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('safety_emergency_plan')">
            <span id="safety_emergency_plan_path"></span>
            <input type="file" class="fileInput" style="display: none;" id="safety_emergency_plan" name="safety_emergency_plan">

            <label for="insurance_documents">7. Insurance Documents</label>
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('insurance_documents')">
            <span id="insurance_documents_path"></span>
            <input type="file" class="fileInput" style="display: none;" id="insurance_documents" name="insurance_documents">

            <label for="PE_Agreements">8. Performer/entertainment Agreements</label>
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('PE_Agreements')">
            ...
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('Participant_Registration_Forms')">
            <span id="Participant_Registration_Forms_path"></span>
            <input type="file" class="fileInput" style="display: none;" id="Participant_Registration_Forms" name="Participant_Registration_Forms">

            <label for="Sponsorship_Agreement">10. Sponsorship Agreement</label>
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('Sponsorship_Agreement')">
            <span id="Sponsorship_Agreement_path"></span>
            <input type="file" class="fileInput" style="display: none;" id="Sponsorship_Agreement" name="Sponsorship_Agreement">

            <label for="Vendor_contracts">11. Vendor Contracts</label>
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('Vendor_contracts')">
            ...
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('Volunteer_Agreements')">
            <span id="Volunteer_Agreements_path"></span>
            <input type="file" class="fileInput" style="display: none;" id="Volunteer_Agreements" name="Volunteer_Agreements">

            <label for="M_P_Materials">13. Marketing and Promotional Materials</label>
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('M_P_Materials')">
            ...
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('Event_Schedule_Timelines')">
            <span id="Event_Schedule_Timelines_path"></span>
            <input type="file" class="fileInput" style="display: none;" id="Event_Schedule_Timelines" name="Event_Schedule_Timelines">

            <label for="Budget_Financial_Reports">15. Budget and Financial Reports</label>
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('Budget_Financial_Reports')">
            <span id="Budget_Financial_Reports_path"></span>
            <input type="file" class="fileInput" style="display: none;" id="Budget_Financial_Reports" name="Budget_Financial_Reports">


            <label for="Environmental_Impact_Assessment">16. Environmental Impact Assessment(if applicable)</label>
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('Environmental_Impact_Assessment')">
            <span id="Environmental_Impact_Assessment_path"></span>
            <input type="file" class="fileInput" style="display: none;" id="Environmental_Impact_Assessment" name="Environmental_Impact_Assessment">

            <label for="PE_Evalution_Report">17. Post-Event Evalution Report</label>
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('PE_Evalution_Report')">
            <span id="PE_Evalution_Report_path"></span>
            <input type="file" class="fileInput" style="display: none;" id="PE_Evalution_Report" name="PE_Evalution_Report">

            <label for="Legal_Permits_Licenses">18. Legal Permits and Licenses</label>
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('Legal_Permits_Licenses')">
            <span id="Legal_Permits_Licenses_path"></span>
            <input type="file" class="fileInput" style="display: none;" id="Legal_Permits_Licenses" name="Legal_Permits_Licenses">

            <label for="Other_Documents">19. Other Documents</label>
            <!-- <input type="text" name="" id="Other_Documents" name="Other_Documents"> -->
            <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('Other_Documents')">
            ...
            <label for="prize_nomination">पुरस्कार नामांकनों:</label>
            <div class="prize">
            ...
            <label for="prize_amount">पुरस्कार राशि या पुरस्कार नाम:</label>
            <input type="text" id="prize_amount-1" name="prize_amount-1" style="display:none" placeholder="पहले पुरस्कार की राशि या पहले पुरस्कार का नाम">
            <input type="text" id="prize_amount-2" name="prize_amount-2" style="display:none" placeholder="दूसरे पुरस्कार की राशि या दूसरे पुरस्कार का नाम">
            <input type="text" id="prize_amount-3" name="prize_amount-3" style="display:none" placeholder="तीसरे पुरस्कार की राशि या तीसरे पुरस्कार का नाम">
            <input type="text" id="prize_amount-4" name="prize_amount-4" style="display:none" placeholder="चौथे पुरस्कार की राशि या चौथे पुरस्कार का नाम">
            <input type="text" id="prize_amount-5" name="prize_amount-5" style="display:none" placeholder="पांचवे पुरस्कार की राशि या पांचवे पुरस्कार का नाम">
            <input type="text" id="prize_amount-6" name="prize_amount-6" style="display:none" placeholder="छठे पुरस्कार की राशि या छठे पुरस्कार का नाम">
            <input type="text" id="prize_amount-7" name="prize_amount-7" style="display:none" placeholder="सातवें पुरस्कार की राशि या सातवें पुरस्कार का नाम">

            <label for="AudienceTicket">दर्शक टिकट राशि: (TAX & सेवा शुल्क)</label>
            <div style="display: flex; justify-content: space-evenly; gap: 10px; width: 95%;">
        
        <input type="text" id="AudienceTicket" name="AudienceTicket" placeholder="INR राशि">
        <input type="text" value="00" id="AudienceTicketGST" style="background-color: lightgray;" name="AudienceTicketGST" readonly>
    </div>

    <label for="ParticipantFee">रेस सहभागिता भुगतान: (TAX & सेवा शुल्क)</label>
    <div style="display: flex; justify-content: space-between; gap: 10px; width: 95%;">
        
        <input type="text" id="ParticipantFee" name="ParticipantFee" placeholder="INR राशि">
        <input type="text" value="00" id="ParticipantFeeGST" style="background-color: lightgray;" name="ParticipantFeeGST" readonly>
            ...
            <label for="race_payment">रेस भुगतान राशि: (TAX & सेवा शुल्क)</label>
            <input type="text" value="2870" id="race_payment" style="background-color: lightgray;" name="race_payment" readonly>

            <label for="bank_details">बैंक विवरण:</label>
            <input type="text" id="bank_details" name="bank_details" placeholder="अपना बैंक नाम दर्ज करें">
            
            <label for="accountno">बैंक खाता नंबर:</label>
            <input type="text" id="accountno" name="accountno">
            
            <label for="IFSC_code">बैंक IFSC कोड:</label>
            <input type="text" id="IFSC_code" name="IFSC_code">
            
            <label for="race_approval">आयोजक के लिए रेस अनुमोदन:</label>
            ...
            <label for="signature">हस्ताक्षर:</label>
            <canvas id="signature-pad"></canvas>
                
            <label for="Signatures_name">हस्ताक्षरकर्ता का नाम:</label>
            <input type="text" id="Signatures_name" name="Signatures_name">

            <input type="hidden" id="Signatures_name" name="Signatures_name">

            <button type="submit" id="organizersubmitbtn">आयोजक द्वारा रेस बुक करें</button>
        </form>
