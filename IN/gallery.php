    ...
    <div class="container">
        <nav class="main-nav">
            ...
            <ul class="nav">
                ...
                <li><a href="gallery.php" class="active">गैलरी</a></li>
    ...
    <div class="header-column-end">
      <?php if ($LogInshowButton): ?>
        <div class="dropdownIO">
          <button style="padding: 5px;"><img src="./images/user-login.png" alt="login" style="height:35px; width: 35px; padding:5px; border-radius:50%; background-color: #90e1f8;"> स्वागत है,</button>
  ...
  <div class="gallery-containers">
    <ul>
      <li>
        <a href="">
          <figure>
            <img src='images/BikeRace.jpg' alt='Bike Race'>
            <figcaption>Bike Race</figcaption>
          </figure>
        </a>
      </li>
      <li>
        <a href="">
          <figure>
            <img src='images/BullCartRace.jpg' alt='Bull Cart Race'>
            <figcaption>Bull Cart Race</figcaption>
          </figure>
        </a>
      </li>
      <li>
        <a href="">
          <figure>
            <img src='images/bullock-cart-race.jpg' alt='Bullock Cart Race'>
            <figcaption>Bullock Cart Race</figcaption>
          </figure>
        </a>
      </li>
      <li>
        <a href="">
          <figure>
            <img src='images/CarRace.jpg' alt='Car Races'>
            <figcaption>Car Race</figcaption>
          </figure>
        </a>
      </li>
      <li>
        <a href="">
          <figure>
            ...
            <figcaption>Cycle Race</figcaption>
          </figure>
        </a>
      </li>
      <li>
        <a href="">
          <figure>
            <img src='images/DogRace.jpg' alt='Dog Races'>
            <figcaption>Dog Races</figcaption>
          </figure>
        </a>
      </li>
      <li>
        <a href="">
          <figure>
            <img src='images/HorceRace.jpg' alt='Horce races'>
            <figcaption>Horce Races</figcaption>
          </figure>
        </a>
      </li>
      <li>
        <a href="">
          <figure>
            <img src='images/HorceRacings.jpg' alt='Horse Racings'>
            <figcaption>Horce Racings</figcaption>
          </figure>
        </a>
      </li>
      <li>
        <a href="">
          <figure>
            <img src='images/HumanRace.jpg' alt='Human Race'>
            <figcaption>Human Race</figcaption>
          </figure>
        </a>
      </li>
      <li>
        <a href="">
          <figure>
            <img src='images/kambala-race.jpg' alt='Kambala Race'>
            <figcaption>Kambala Race</figcaption>
          </figure>
        </a>
      </li>
      <li>
        <a href="">
          <figure>
            <img src='images/motorboatrace.jpg' alt='Motor Boat Race'>
            <figcaption>Motor Boat Race</figcaption>
          </figure>
        </a>
      </li>
      <li>
        <a href="">
          <figure>
            <img src='images/RacingCar.jpg' alt='Racing Cars'>
            <figcaption>Racing Cars</figcaption>
          </figure>
        </a>
      </li>
    </ul>
    ...
    <div class="calendar-contain">
      <div class="calendar-titlebar">
        ...
        <div class="calendar-controls">
          <label for="select-year">साल:</label>
          <select id="select-year" onchange="changeCalendar()"></select>
          <label for="select-month">महीना:</label>
