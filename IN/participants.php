...
<div class="sub-header-2">
  ...
  <div class="columns">
    ...
    <div class="header-column-2">
      <h6><a href="participants.php" class="sub-header-2active">प्रतिभागी</a></h6>
    </div>
...
<!-- ***** दूसरा सब हेडर एरिया समाप्त ***** -->
    ...
    <div class="participant-container">
        <h5>रेस प्रतिभागी आवेदन फॉर्म</h5>
        <form id="raceParticipentsForm" action="bookparticipant.php" method="post" enctype="multipart/form-data">

        <label for="race_name" id="race_name">भाग लेने के लिए उपलब्ध रेस चुनें:</label>
...
// 		$conn = sqlsrv_connect($serverName, $connectionOptions);
    ...
    <div id="raceDetails">
        <!-- Display fetched details here -->
            ...
            <label for="P_photo_id">1. फोटो पहचान प्रमाण - "आधार कार्ड, ड्राइविंग लाइसेंस, पैन कार्ड"</label>
        <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('P_photo_id')">
        <span id="P_photo_id_path"></span>
        <input type="file" class="fileInput" style="display: none;" id="P_photo_id" name="P_photo_id">

        <label for="P_waiver_liability">2. उत्तरदायित्व की छूट</label>
        <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('P_waiver_liability')">
        ...
        <label for="P_medical_clearence_consent">3. चिकित्सा स्पष्टता या सहमति</label>
        <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('P_medical_clearence_consent')">
        ...
        <label for="P_proof_entry_fee">4. प्रवेश शुल्क भुगतान का कानूनी प्रमाण</label>
        <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('P_proof_entry_fee')">
        ...
        <label for="P_T_G_Registration">5. टीम या समूह पंजीकरण विवरण - "संयोजन या जोड़ें टोकन विवरण (यूनिक कोड)"</label>
        <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('P_T_G_Registration')">
        ...
        <label for="P_C_D_Approval">6. कपड़े या ड्रेस कोड की स्वीकृति (यदि लागू हो)</label>
        <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('P_C_D_Approval')">
        <span id="P_C_D_Approval_path"></span>
        <input type="file" class="fileInput" style="display: none;" id="P_C_D_Approval" name="P_C_D_Approval">

        <label for="P_Other_Documents">7. अन्य दस्तावेज़</label>
        <input type="button" class="purple-button" value="फाइल चुनें" onclick="triggerFileInput('P_Other_Documents')">
      ...
      <label for="bank_details">पुरस्कार के लिए बैंक विवरण</label>
            ...
            <label for="p_accountno">बैंक खाता नंबर</label>
            <input type="text" id="p_accountno" name="p_accountno">

            <label for="p_IFSC_code">बैंक IFSC कोड:</label>
            <input type="text" id="p_IFSC_code" name="p_IFSC_code">
            
            <label for="p_race_approval">साइट और आयोजक से प्रतिभागी की स्वीकृति:</label>
            <div>
            ...
            <button id="payButton" type="submit">रेस में भाग लें</button>
        </form>
<script>
