...
<div class="sub-header-1">
  ...
  <div class="signup-container">
    ...
    <form action="Register.php" method="post">
      ...
      <table>
        <tr>
          <td><label for="UserName">नाव:</label></td>
          <td><input type="text" id="UserName" name="UserName" required></td>
        </tr>
        <tr>
          <td><label for="UserAddress">पत्ता:</label></td>
          <td><textarea id="UserAddress" name="UserAddress" required></textarea></td>
        </tr>
        <tr>
          <td><label for="UserPostalCode">पिनकोड:</label></td>
          <td><input type="text" id="UserPostalCode" name="UserPostalCode" required></td>
        </tr>
        <tr>
          <td><label for="UserCountry">देश:</label></td>
          <td>
        ...
        <tr>
          <td><label for="UserDistirct">जिल्हा:</label></td>
          <td>
        ...
        <tr>
          <td><label for="UserTaluka">तालुका:</label></td>
          <td>
        ...
        <tr>
          <td><label for="UserEmailcPasscode">पासवर्डची पुष्टी:</label></td>
          <td class="password-container">
          ...
          function validatePassword() {
            ...
            if (password.trim() !== "") {
              ...
              if (!passwordRegex.test(password)) {
                passwordError.textContent = "पासवर्डमध्ये किमान एक वर्णमाला, एक चिन्ह, एक संख्या आणि किमान 8 वर्ण असणे आवश्यक आहे";
                return false;
              }

              if (password !== confirmPassword) {
                confirmPasswordError.textContent = "पासवर्ड जुळत नाही.";
                return false;
              }
            }
            return true;
        ...
        <tr>
          <td>
            <label for="UserMobileNumber">मोबईल नंबर:</label>
          </td>
          <td>
        ...
        <tr>
          ...
          <td>
            <button type="button" id="send_otp_button" onclick="sendOTP()">Send OTP</button>
          </td>
        </tr>
        <tr>
      ...
      <div class="form-check">
        <label class="form-check-label">
          ...
          मी या वेबसाइटवरील <a onclick="openPopup()" href="../Terms and Conditions GoRacings.pdf"
            download="">अटी व शर्ती</a> वाचल्या आहेत आणि त्यांच्याशी सहमत आहे.
        </label>
      </div>

      <button type="submit" id="registerButton">Register</button>

      <p>खाते आधीच आहे का? <a href="login.php">लॉगिन</a></p>
