...
<div class="sub-header-1">
  ...
  <div class="columns">
    ...
    <div class="header-column-2">
      <h6><a href="participants.php" class="sub-header-2active">सहभागी</a></h6>
    </div>
...
<script>
  ...
  <!-- ***** second sub Headerr Area End ***** -->
    ...
    <select id="raceName" name="raceName" placeholder="उपलब्ध शर्यत निवडा">
        <?php
        include 'gRconn.php';
...
// 		$conn = sqlsrv_connect($serverName, $connectionOptions);
    ...
    <div id="raceDetails">
        <!-- Display fetched details here -->
            ...
            <label for="P_photo_id">1. फोटो आयडी प्रूफ - "आधार कार्ड, ड्रायव्हिंग लायसन्स, पॅन कार्ड"</label>
        <input type="button" class="purple-button" value="फाइल निवडा" onclick="triggerFileInput('P_photo_id')">
        <span id="P_photo_id_path"></span>
        <input type="file" class="fileInput" style="display: none;" id="P_photo_id" name="P_photo_id">

        <label for="P_waiver_liability">2. दायित्व माफ</label>
        <input type="button" class="purple-button" value="फाइल निवडा" onclick="triggerFileInput('P_waiver_liability')">
        ...
        <label for="P_medical_clearence_consent">3. संमतीसाठी वैद्यकीय मंजुरी</label>
        <input type="button" class="purple-button" value="फाइल निवडा" onclick="triggerFileInput('P_medical_clearence_consent')">
        ...
        <label for="P_proof_entry_fee">4. प्रवेश शुल्क भरल्याचा कायदेशीर पुरावा</label>
        <input type="button" class="purple-button" value="फाइल निवडा" onclick="triggerFileInput('P_proof_entry_fee')">
        ...
        <label for="P_T_G_Registration">5. संघ किंवा गट नोंदणी तपशील- "टोकन तपशील एकत्र करा किंवा जोडा (युनिक कोड)"</label>
        <input type="button" class="purple-button" value="फाइल निवडा" onclick="triggerFileInput('P_T_G_Registration')">
        ...
        <label for="P_C_D_Approval">6. पोशाख किंवा ड्रेस कोडची मान्यता (लागू असल्यास)</label>
        <input type="button" class="purple-button" value="फाइल निवडा" onclick="triggerFileInput('P_C_D_Approval')">
        <span id="P_C_D_Approval_path"></span>
        <input type="file" class="fileInput" style="display: none;" id="P_C_D_Approval" name="P_C_D_Approval">

        <label for="P_Other_Documents">7. इतर कागदपत्रे</label>
        <input type="button" class="purple-button" value="फाइल निवडा" onclick="triggerFileInput('P_Other_Documents')">
        ...
        <input type="file" class="fileInput" style="display: none;" id="P_Other_Documents" name="P_Other_Documents">
            ...
            <label for="bank_details">बँक तपशील - पुरस्कारासाठी</label>
            ...
            <label for="p_accountno">बँक खाते क्रमांक:</label>
            <input type="text" id="p_accountno" name="p_accountno">

            <label for="p_IFSC_code">बँक IFSC कोड:</label>
            <input type="text" id="p_IFSC_code" name="p_IFSC_code">
            
            <label for="p_race_approval">साइट आणि आयोजकांकडून सहभागी मंजूरी:</label>
            <div>
            ...
            <button id="payButton" type="submit">रेसमध्ये सहभागी व्हा</button>
        </form>
<script>
