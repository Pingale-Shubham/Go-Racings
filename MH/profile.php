...
<div class="sub-header-1">
  ...
  <div class="columns">
    ...
    <div class="header-column-4">
      <h6><a href="profile.php" class="sub-header-2active">वापरकर्ता प्रोफाइल</a></h6>
    </div>
  </div>
...
<script>
  ...
  <div class="profile-area">
    ...
    <ul>
    <!-- <li><a href="#Organizer-Prize" class="tab-link">आयोजक पारितोषिक व्यवस्थापन</a></li>
    <li><a href="#Participant-Prize" class="tab-link">भाग घेणाऱ्यांचे पारितोषिक व्यवस्थापन</a></li> -->
    <li><a href="#profile-info" class="tab-link">प्रोफाइल</a></li>
    <li><a href="#organizer-info" class="tab-link">आयोजक व्यवस्थापन</a></li>
    <li><a href="#participants-info" class="tab-link">भाग घेणाऱ्यांचे व्यवस्थापन</a></li>
    <li><a href="#audience-info" class="tab-link">प्रेक्षक व्यवस्थापन</a></li>
  </ul>
  </div>
          ...
          if ($conn) {
            ...
            if ($stmt) {
              ...
              while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                echo "<tr>";
                echo "<td class=\"table-head\">नाव:</td><td>" . $row['UserName'] . "</td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td class=\"table-head\">मोबाईल नंबर:</td><td>" . $row['UserMobileNumber'] . "</td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td class=\"table-head\">ईमेल:</td><td>" . $row['UserEmailID'] . "</td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td class=\"table-head\">अड्रेस:</td><td>" . $row['UserAddress'] . "</td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td class=\"table-head\">युनिक कोड:</td><td>" . $row['UserAllotedTokenNumber'] . "</td>";
                echo "</tr>";
              }
              echo "</table>";
