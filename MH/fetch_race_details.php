...
if (isset($_POST['raceName']) AND isset($_POST['tokenNumber'])) {
    ...
    if ($row !== false) {
        ...
        echo "
			...
			<label for='race_prizes'>रेस पारितोषिक:</label>
			";
			
			if ($PrizeAmountOne != 0) {
				echo "					
				पहिले पारितोषिक: <input type='text' name='PrizeOne' id='PrizeOne' value='$PrizeAmountOne' style='background-color: lightgray;' readonly>
				";
			}
			
			if ($PrizeAmountTwo != 0) {
				echo "	
				दुसरे पारितोषिक: <input type='text' name='PrizeTwo' id='PrizeTwo' value='$PrizeAmountTwo' style='background-color: lightgray;' readonly>
			";
			}
			if ($PrizeAmountThree != 0) {
				echo "	
				तिसरे पारितोषिक: <input type='text' name='PrizeThree' id='PrizeThree' value='$PrizeAmountThree' style='background-color: lightgray;' readonly>
			";
			}
			
			if ($PrizeAmountFour != 0) {
				echo "	
			    चौथे पारितोषिक: <input type='text' name='PrizeFour' id='PrizeFour' value='$PrizeAmountFour' style='background-color: lightgray;' readonly>
			";
			}
			
			if ($PrizeAmountFive != 0) {
				echo "	
                पाचवे पारितोषिक: <input type='text' name='PrizeFive' id='PrizeFive' value='$PrizeAmountFive' style='background-color: lightgray;' readonly>
			";
			}
			
			if ($PrizeAmountSix != 0) {
				echo "	
			    सहावे पारितोषिक: <input type='text' name='PrizeSix' id='PrizeSix' value='$PrizeAmountSix' style='background-color: lightgray;' readonly>			
			";
			}
			
			if ($PrizeAmountSeven != 0) {
				echo "	
			    सातवे पारितोषिक: <input type='text' name='PrizeSeven' id='PrizeSeven' value='$PrizeAmountSeven' style='background-color: lightgray;' readonly>
			";
			}
			echo "
            <label for='p_racepayment'>सहभागी तिकिटाची रक्कम: (कर आणि सेवा शुल्क)</label>
