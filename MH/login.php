...
<div class="sub-header-1">
  ...
  <div class="login-container">
    ...
    <div class="login-options">
      <button onclick="showOTPForm()">OTP सह लॉगिन </button>
      <button onclick="showEmailForm()">ईमेल सह लॉगिन</button>
    </div>
    <div id="otp-form" style="display:none">
      <h3>OTP सह लॉगिन करा</h3>
      <form action="signin.php" method="POST">
        <input type="tel" id="UserMobileNumber" name="UserMobileNumber" placeholder="मोबाईल नंबर प्रविष्ट करे " required>
        <button type="button" id="send-otp-btn" onclick="sendOTP()">OTP पाठवा</button>
        <input type="text" id="UserMobileNumberOTP" name="UserMobileNumberOTP" placeholder="प्राप्त झालेला OTP प्रविष्ट करा"
          required>
        <button type="button" id="verify_otp_button" onclick="verifyOTP()">OTP सत्यापित करा</button>
        <button type="submit" id="login_button" disabled>लॉगिन करा</button>
        <p>Don't have an account? <a href="register.php">नोंदणी करा</a></p>
      </form>
    </div>
    ...
    <div id="email-form" style="display: none;">
      <h3>ईमेल सह लॉगिन करा</h3>
      <form action="signin.php" method="POST">
        <table>
          <tr>
            <td><label for="UserEmailID">ईमेल :</label></td>
            <td><input type="email" id="UsrEmailID" name="UserEmailID" placeholder="तुमचा ईमेल प्रविष्ट करा" required>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td>
              <div class="captchafield">
                <div class="verifycaptcha">
                  <button type="button" onclick="validateRefreshCaptcha()">सत्यापित करा</button>
                </div>
            ...
            <td><input type="text" placeholder="कॅप्चा प्रविष्ट करा" name="user_captcha" id="user_captcha" /></td>
          </tr>
        </table>
        ...
        <div class="add-options">
          ...
          <a href="forgot.php">पासवर्ड विसरलात?</a>
        </div>
        <button type="submit">लॉगिन करा</button>
        <p id="signingup">खाते नाही?<a href="register.php">नोंदणी करा</a></p>
      </form>
