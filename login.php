...
<body>
  ...
  <div class="login-container">
    ...
    <div class="login-options">
      <button onclick="showOTPForm()">Login with OTP</button>
      <button onclick="showEmailForm()">Login with Email</button>
    </div>
      ...
      <form action="signin.php" method="POST">
        <table>
          <tr>
            ...
            <td><input type="email" id="UserEmailID" name="UserEmailID" placeholder="Enter your email address" required>
            </td>
          </tr>
          <tr>
            <td><label for="UserEmailPasscode">Password:</label></td>
          ...
          <tr>
            <td>
              <div class="captchafield">
                <div class="verifycaptcha">
                  <button type="button" onclick="validateRefreshCaptcha()">Verify</button>
                </div>
            ...
            <td><input type="text" placeholder="Enter Captcha" name="user_captcha" id="user_captcha" /></td>
          </tr>
        </table>
        ...
        <div class="add-options">
          ...
          <a href="../goracings/forgot.php">Forgot Password?</a>
        </div>
        <button type="submit">Login</button>
        <p id="signingup">Don't have an account? <a href="register.php">Register</a></p>
      </form>
      <script src="../goracings/captcha-generator/asset/main.js"></script>
    </div>
  </div>
