...
<body>
  <div style="position: absolute; top: 10px; right: 10px;">
    <!-- <a href="MH/index.php">स्विच करा मराठीमध्ये</a> -->

    <select id="language-select" onchange="switchLanguage()" style="padding: 5px;">
    ...
    <script>
        function switchLanguage() {
            ...
            window.location.href = language + "/index.php";
        }
    </script>
  </div>
...
<div class="sub-header-2">
  ...
  <footer>
    ...
    <div class="footer-line-2">
      <p>
        <span>&copy; 2024. Swyom, Swyomsoft And Swyom Enterprises.</span> All Rights Reserved.
      </p>
    </div>
